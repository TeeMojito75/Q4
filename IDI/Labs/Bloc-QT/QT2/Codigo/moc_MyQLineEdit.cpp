...
QT_MOC_LITERAL(1, 12, 11), // "enviarTexto"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 14) // "capturarReturn"

    },
    "MyQLineEdit\0enviarTexto\0\0capturarReturn"
};
...
void MyQLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->enviarTexto((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->capturarReturn(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQLineEdit::enviarTexto)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyQLineEdit::enviarTexto(const QString & _t1)
{
