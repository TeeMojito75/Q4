...
void MyGLWidget::initializeGL() {
  ...
  colorFocus = glm::vec3(1,1,0);
  glUniform3fv(colorLoc, 1, &colorFocus[0]);

  colorFocusCamera = glm::vec3(1,1,1);
...
void MyGLWidget::keyPressEvent(QKeyEvent* event) {
  ...
  switch (event->key()) {
    ...
    case Qt::Key_1 :
      if (colorFocus.x == 0) colorFocus = glm::vec3(1,1,0);
    ...
    case Qt::Key_2 :
      if (colorFocusCamera.x == 0) colorFocusCamera = glm::vec3(1,1,1);
